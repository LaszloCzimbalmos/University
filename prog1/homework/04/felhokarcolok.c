...
//Szomszédos indexű egész számok különbségének abszolút értékét adja össze.
int magassag_kulonbseg(int len, int arr[])
{
    int ossz = 0;
    for(int i = 0; i < len - 1; i++)
    {
        ossz += abs(arr[i] - arr[i + 1]);
    }
